...
int disassembleInstruction(Chunk* chunk, int offset) {
	...
	case OP_DEFINE_PROPERTY_CONST:		return constantInstruction("def const prop", chunk, offset);
	case OP_DEFINE_PROPERTY_CONST_POP:	return constantInstruction("def const prop (pop)", chunk, offset);
	...
	case OP_ADD_SET_PROPERTY:			return constantInstruction("add set prop", chunk, offset);
	case OP_SUBTRACT_SET_PROPERTY:		return constantInstruction("sub set prop", chunk, offset);
	case OP_MULTIPLY_SET_PROPERTY:		return constantInstruction("mul set prop", chunk, offset);
	case OP_DIVIDE_SET_PROPERTY:		return constantInstruction("div set prop", chunk, offset);
	case OP_MODULUS_SET_PROPERTY:		return constantInstruction("mod set prop", chunk, offset);
